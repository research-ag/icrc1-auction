...
do {
  ...
  let ft = createFt(auction);
  let buyer = Principal.fromText("khppa-evswo-bmx2f-4o7bj-4t6ai-burgf-ued7b-vpduu-6fgxt-ajby6-iae");
  ignore auction.appendCredit(buyer, 0, 5_000_000_000, null);
  ...
  ignore auction.appendCredit(mediumSeller, ft, 500_000_000, null);
  ...
  ignore auction.appendCredit(highSeller, ft, 500_000_000, null);
  ...
  ignore auction.appendCredit(lowSeller, ft, 500_000_000, null);
  ...
  ignore auction.appendCredit(newSeller, ft, 500_000_000, null);
