...
do {
  Prim.debugPrint("surplus issue test 18.08.2026 ...");
  ...
  ignore auction.placeOrder(users[0], #bid, 1, #delayed, 5_000_000_000_000_000_000, 1_000.0, null, runtime);

  ignore auction.placeOrder(users[1], #ask, 1, #delayed, 1_666_666_666_666_666_666, 1_000.0, null, runtime);
  ignore auction.placeOrder(users[2], #ask, 1, #delayed, 1_666_666_666_666_666_666, 1_000.0, null, runtime);
  ignore auction.placeOrder(users[3], #ask, 1, #delayed, 1_666_666_666_666_666_666, 1_000.0, null, runtime);
